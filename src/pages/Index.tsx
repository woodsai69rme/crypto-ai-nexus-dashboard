...
const Index = () => {
  ...
  useEffect(() => {
    ...
    const initializeApp = async () => {
      try {
        console.log('Initializing CryptoMax Dashboard...');
        ...
        toast({
          ...
          description: "Failed to load market data. Some features may be limited.",
          variant: "destructive"
        });
      }
    };
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
              <div className="xl:col-span-2 space-y-4">
                <ErrorBoundary fallback={
                  <div className="p-4 bg-slate-800/50 border border-red-500/30 rounded-lg text-center">
                    <p className="text-red-400">Failed to load trading chart</p>
                  </div>
                }>
